...
?>
        ...
        <div class="grid-item item3">
            <div class="apicture">
                <img src="images/agent12.jpg">
            </div>
            <div class="adetails">
                <p class="heading">Jeffry, Jeffry Bezos</p>
                <p class="detals">Beyond his practical skills, Bezos brings a unique perspective to the role of a bodyguard,
                     drawing from his experiences as a visionary leader who has navigated the complexities of the digital age.
                      His forward-thinking mindset allows him to stay one step ahead of potential threats,
                     while his relentless drive ensures that he will stop at nothing to protect those entrusted to his care.
                </p>

...
<body>
    <div class="grid-container">
        ...
        <div class="grid-item item3">
            ...
            <div class="adetails">
                <p class="heading">Ranbo, John Ranbo</p>
                <p class="detals">A human but a strong one Rambo has command on all sorts of weapons and machinery
                     with high battle iq through the combination of which he will put 
                    his life on the line just so you will be safe. He also has melee combat experience through his 
                    alter ego rocky which makes him deadly without weapons as well..
                </p>

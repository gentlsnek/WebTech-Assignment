...
?>
        ...
        <div class="grid-item item3">
            <div class="apicture">
                <img src="images/agent11.jpg">
            </div>
            <div class="adetails">
                <p class="heading">Kman, unknown</p>
                <p class="detals">Equipped with advanced weaponry and a tactical mind capable of outsmarting any foe, K-Man navigates the treacherous
                     landscapes of his world with ease. Whether it's escorting a high-profile scientist
                     through the hazardous Black Mesa Research Facility or safeguarding vital assets from the relentless assaults of alien invaders,
                      he is the epitome of reliability in the face of chaos.
                </p>

...
?>
        ...
        <div class="grid-item item3">
            ...
            <div class="apicture">
                <img src="images/agent10.jpg">
            </div>
            <div class="adetails">
                <p class="heading">Agent 47, unknown</p>
                <p class="detals">Stealth being key he takes away danger from you without danger even knowing what hit it. Gunfire,
                     infiltration and taking down numerous cartels and terrorist organisations agent 47
                      is our complete package with no hesitation to kill for the people he sides with.
                </p>

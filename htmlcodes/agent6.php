...
?>
        ...
        <div class="grid-item item3">
            <div class="apicture">
                <img src="images/agent6.jpg">
            </div>
            <div class="adetails">
                <p class="heading">Khabib, khabib Nurmagomedov</p>
                <p class="detals">If you thought mcgregor was a complete package the Russian monster 1 ups him. 
                    lethal speed, fighting technique and unreal composure combined with the Rasputin and vodka instincts adds him to your backing.
                </p>
